<template>
  <div class="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden flex flex-col h-full group">
    <!-- Imagem do produto -->
    <div class="relative bg-gray-50 p-6 h-64 flex items-center justify-center overflow-hidden">
      <img 
        :src="product.image" 
        :alt="product.title"
      ...
      <!-- Rating -->
      <div class="absolute top-2 right-2 bg-white/90 backdrop-blur-sm px-2 py-1 rounded-full flex items-center space-x-1">
